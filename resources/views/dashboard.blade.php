            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class=" w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                    <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            <div
                                ...
                                <span class="w-7 h-7 flex items-center justify-center text-gray-500 dark:text-gray-400"><i
                                        class="fa-solid fa-ship"></i></span>
                            ...
                            <div>
                                <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">Jumlah
                                    Pengiriman & Penerimaan</h5>
                                <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Tahun 2024
                                </p>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1">
                        <dl class="flex items-center">
                            <dt class="text-gray-500 dark:text-gray-400 text-lg font-medium me-1">Jumalah Bulan Ini
                            </dt>
                        </dl>
                    </div>
                    <div class="grid grid-cols-2">
                        <dl class="flex items-center">
                            <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">Pengiriman :
                            </dt>
                            <dd class="text-gray-900 text-sm dark:text-white font-semibold">$3,232</dd>
                        </dl>
                        <dl class="flex items-center justify-end">
                            <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">Penerimaan:</dt>
                        ...
                        <div class="flex justify-between items-center pt-5">
                            ...
                            <div id="lastDaysdropdown"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="#"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2026</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2027</a>
                                    </li>
                                </ul>
                            </div>
                            <a href="#"
                ...
                <div class=" w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                    ...
                    <div class="flex justify-between items-start w-full">
                        <div class="flex-col items-center">
                            <div class="flex items-center mb-1">
                                <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Mitra
                                    Analytics</h5>
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center pt-5">
                            <!-- Button -->
                            <button id="mitraPengirimanAnalytics" data-dropdown-toggle="lastDaysdropdown1"
                                data-dropdown-placement="bottom"
                                class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 text-center inline-flex items-center dark:hover:text-white"
                                type="button">
                                Last 7 days
                            ...
                            <div id="lastDaysdropdown1"
                                class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    aria-labelledby="mitraPengirimanAnalytics">
                                    <li>
                                        <a href="#"
