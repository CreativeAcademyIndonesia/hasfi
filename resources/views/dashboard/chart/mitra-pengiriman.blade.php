<div class=" w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 col-span-4">
    ...
    <div class="flex justify-between items-start w-full">
        <div class="flex-col items-center">
            <div class="flex items-center mb-1">
                <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Pengiriman Mitra</h5>
                ...
                <div data-popover id="chart-info" role="tooltip"
                    ...
                    <div class="p-3 space-y-2">
                        ...
                        <p>Berikut merupakan data pengiriman mitra.</p>
                    </div>
                    <div data-popper-arrow></div>
                </div>
            </div>
            <button id="datePengirimanMitra" data-dropdown-toggle="dateRangeDropdownPengirimanMitra"
        ...
        <div class="flex justify-end items-center">
            <button id="widgetPengirimanMitra" data-dropdown-toggle="widgetDropdownPengirimanMitra" data-dropdown-placement="bottom"
                type="button"
            ...
            <div id="widgetDropdownPengirimanMitra"
                class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="widgetPengirimanMitra">
                    <li>
                        <a href="#"
    ...
    <!-- Line Chart -->
    <div class="py-6" id="chart-mitra-pengiriman"></div>

    <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
        <div class="flex justify-between items-center pt-5">
            <!-- Button -->
            <button id="mitraPengirimanAnalytics" data-dropdown-toggle="lastDropdownPengirimanMitra"
            ...
            <div id="lastDropdownPengirimanMitra"
                class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="mitraPengirimanAnalytics">
                    <li>
                        <a href="#"
