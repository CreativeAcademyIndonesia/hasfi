<div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    ...
    <div class="flex items-center">
        ...
        <i class="fas fa-users text-gray-500 dark:text-gray-400 text-2xl"></i>
        </div>
        <div>
    ...
    <div>
        ...
        <i class="fas fa-arrow-up text-xs me-1.5"></i>
        42.5%
        </span>
    </div>
    </div>
    ...
    <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
        ...
        <button
            ...
            type="button">
            Tahun 2024
            <i class="fas fa-chevron-down text-xs ms-1.5"></i>
        </button>
        <!-- Dropdown menu -->
        <div id="lastDaysdropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                ...
                <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2026</a>
                </li>
                <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2027</a>
                </li>
            </ul>
        </div>
        <a
            ...
            Dashboard
            <i class="fas fa-chevron-right text-xs ms-1.5"></i>
        </a>
        </div>
    </div>
</div>